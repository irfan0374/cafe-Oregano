    ...
    return (
        <>
            ...
            <div className=''>
                ...
                <div className='  container w-full p-4 h-screen md:h-80'>
                    {/* carousal */}
                    <div className="w-80 carousel h-80 ml-2 rounded-md">
                    ...
                    <div className='flex gap-2 justify-center py-2'>
                        <div> <img className='w-20 h-20 object-cover rounded-md' src={shakes} alt="" /></div>
                        <div> <img className='w-20 h-20 object-cover rounded-md' src={shakes} alt="" /></div>
        ...
        <div className=" flex justify-center">
            <button className=' border px-24 border-black py-3' onClick={openDrawerBottom}>REVIEWS  +</button>
      </div>
      <Drawer
        placement="bottom"
        open={openBottom}
                    ...
                    <div >
                        <div className="flex flex-col p-8 rounded-2xl bg-white">
                            <div className="flex">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <div className="font-light text-md text-[#4b587c]">Cool guy</div>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-4 text-[#005ef6] text-xl tracking-[2px]">★★★★★</div>
                            ...
                            <div className="flex gap-6 text-[#4b587c] text-[12px] mt-4">
                                ...
                                <span className="cursor-pointer hover:text-[#ff6154]">Share</span>
